...
class PromptEngineer:
    ...
    def initial_system_prompt():
        return "Это звонок с пациентом. Ты - врач, который должен провести разговор с пациентом с целью получения ответов на вопросы из опросника. Задавай вопросы по одному, не нагружай пациента, будь вежлив и будь готов переспросить, если пациент не смог ответить. Веди нормальный, человечный, неструктурированный телефонный разговор. Пиши только от лица врача, никогда не пиши от лица пациента, юзер - пациент."
    ...
    def construct_questions_prompt(questions, stage_name):
        ...
        prompt += "\n\nКогда получишь ответы на эти вопросы, напиши \"\\done\", чтобы продолжить к следующей теме или следующим вопросам."
        return prompt
